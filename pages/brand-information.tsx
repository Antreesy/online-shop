                ...
                <div className={s.brandInfo}>
                    <div className={s.brandItem}>
                        ...
                        <div className={s.textBlock}>
                            ...
                            <p className={s.description}>Yves Henri Donat Mathieu-Saint-Laurent</p>
                        </div>
                    </div>
                    <div className={s.brandDisplay}>
                        ...
                        <div className={s.textBlock}>
                            ...
                            <p className={s.description}>Yves Saint Laurent</p>
                        </div>
                    </div>
                </div>
            ...
            <div className={s.formSection}>
                <div className={s.container}>
                    <div className={s.firstLineInputs}>
                        <Input value="" setValue={() => { }} className={s.input} label='Brand Name' isRequired />
                        <Input value="" setValue={() => { }} className={s.input} label='Cari Ünvan' />
                        <Input value="" setValue={() => { }} className={s.input} label='Brand Name' />
                    </div>
                    <div className={s.secondLineInputs}>
                        <Input value="" setValue={() => { }} className={s.input} label='Brand Name' isRequired />
                        <Input value="" setValue={() => { }} className={s.input} label='Tax Administration' />
                        <Input value="" setValue={() => { }} className={s.input} label='KEP Address' />
                    </div>
                    <Input value="" setValue={() => { }} className={s.inputTextArea} label='Tax number' />
