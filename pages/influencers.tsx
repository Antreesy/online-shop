    ...
    <>
      ...
      <div className={s.scrollContainer}>
        <div className={s.container}>
          <h1 className={s.heading}><span>Featured Influencer’s Shops</span></h1>
          <p className={s.description}>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aspernatur
            ipsam modi fugiat autem earum aliquam delectus eaque facilis eum,
            harum consequuntur vero nisi! Mollitia, quo. Sapiente, eaque? Et,
            maiores nisi. Doloribus corporis repellat eveniet maiores. Impedit
            temporibus perspiciatis animi expedita tenetur tempore maxime odio
            saepe repudiandae sed accusamus commodi voluptatem, eos inventore
            quaerat ut nihil aliquam, consequuntur, ad repellendus.
            <br />
            <br />
            ...
            optio illum similique corrupti, consequuntur quae nihil ut, repellat
            quas cupiditate odit pariatur!
          </p>
