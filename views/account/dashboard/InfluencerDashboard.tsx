...
export const InfluencerDashboard: React.FC<AddressProps> = (props) => {
    return (
        <>
                ...
                <Tabs
                        ...
                        <div style={{paddingTop: "47px"}}>
                            ...
                            <div className={s.row}>
                                ...
                                <div className={s.search_block}>
                                    ...
                                    <Button className={cn(s.button_black, s.search_btn)}>Search</Button>
                                </div>
                                <Button className={cn(s.button_black, s.clean_btn)}>Clean</Button>
                            </div>
                            <div className={s.table__head}>
                                <span className={s.table__head__title}>Product Based Sales Statistics</span>
                  ...
                  <span className={s.table__head__results}>
                    Filtering Results: Total 112230 Product Information
                                        ...
                                        <span className={s.table__head__update}>Last Updated: 24.12.2021</span>
                                    </div>
                            ...
                            <Table
                                headers={[
                                    ...
                                    {name: "Average Selling Price", isSort: true, alignCenter: true},
                                    {name: "Current Turnover", isSort: false, alignCenter: true},
                        ...
                        <div style={{paddingTop: "47px"}}>
                            ...
                            <div className={s.table__head}>
                                <span className={s.table__head__title}>Category Based Sales Statistics</span>
                                <div style={{display: "flex"}}>
                                    <div style={{display: "flex", flexDirection: "column", marginRight: "25px"}}>
                  <span className={s.table__head__results}>
                    Filtering Results: Total 112230 Product Information
                        ...
                        <div style={{paddingTop: "47px"}}>
                            ...
                            <div className={s.row}>
                                <Button variant={"outlined"} className={cn(s.clean_btn, s._brand)}>Clean</Button>
                                <Button className={cn(s.button_black, s.search_btn, s._brand)}>Search</Button>
                            </div>
                            <div className={s.table__head}>
                                <span className={s.table__head__title}>Brand Based Sales Statistics</span>
                                <div style={{display: "flex"}}>
                                    <div style={{display: "flex", flexDirection: "column", marginRight: "25px"}}>
                  <span className={s.table__head__results}>
                    Filtering Results: Total 112230 Product Information
